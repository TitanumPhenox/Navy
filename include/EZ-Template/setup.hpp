...
const int  L_CHASSIS_PORTS[MOTORS_PER_SIDE] = {14, -2, 12}; // Ports, the first number will be used for sensing
const int  R_CHASSIS_PORTS[MOTORS_PER_SIDE] = {3, -1, 18}; // Ports, the first number will be used for sensing
